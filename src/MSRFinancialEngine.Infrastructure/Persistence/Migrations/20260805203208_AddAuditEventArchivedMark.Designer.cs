...
namespace MSRFinancialEngine.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260805203208_AddAuditEventArchivedMark")]
    partial class AddAuditEventArchivedMark
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MSRFinancialEngine.Domain.Entities.AuditArchive", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("audit_archives", (string)null);
                });
            ...
            modelBuilder.Entity("MSRFinancialEngine.Domain.Entities.ImportJob", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MSRFinancialEngine.Domain.Entities.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
